...
final class SupplementaryViewController: UIViewController, ListAdapterDataSource {
    ...
    override func viewDidLoad() {
        ...
        if let flowLayout = collectionView.collectionViewLayout as? ListCollectionViewLayout {
            ...
            let navigationBarVisible = self.navigationController?.isNavigationBarHidden == false ?? false
            let navigationBarHeight = ( navigationBarVisible ? self.navigationController?.navigationBar.frame.height : 0 ) ?? 0
